...
public class Client {
	...
	*  final     -> Son inmutables, siempre trabajamos con un objeto java que representa un cliente 
	...
	*/
	...
	/**
	 * JUSTIFICACION: Son inmutables, siempre trabajamos con un objeto java que representa un cliente
	 * y ninguna pieza del código puede modificar estos datos
	 ...
	 * JUSTIFICAION: El constructor tiene que obligar que esos campos sean necesarios y obligatorios, 
	 * por lo tanto son campos del constructor, es decir sin esos campos no se puede crear un cliente
	 * @param dni
	 * @param name
	 */
