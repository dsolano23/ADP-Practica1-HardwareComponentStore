...
/**
 * ENUNCIADO: En el diagrama dice que ComponentInShoppingCart IsTypeOf Component , por eso extiende de component, pero no esto nada de acuerdo con este diseño.
 * 
 * @author dpena
 *
 */
public class ComponentInShoppingCart extends Component{
	...
	public ComponentInShoppingCart(String name, String description, Integer price, Integer stock, Date date, Integer hour, Integer units) {
